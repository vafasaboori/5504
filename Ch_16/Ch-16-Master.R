...
# GAM is a flexible model for complex non-linear relationships without assuming a specific functional form.
# Other methods:
...
# Section 9 Autocorrelation and Durbin Watson Test (Q24 Closing Price) ----
library(readxl)
...
# At alpha of 0.05 with one IV dL = 1.20, and dU = 1.41, our d < dL sig. autocorr
